...
const TESTIMONIALS = [
    { text: "Precisávamos de uma escavadeira CAT para uma obra urgente e a Jacó entregou em menos de 48 horas.", author: "Rafael C.", company: "Construtora · Florianópolis" },
    ...
    { text: "Trabalhamos com a Jacó há mais de 5 anos. Sempre máquinas bem cuidadas e atendimento rápido.", author: "André P.", company: "Indústria · Criciúma" },
        ...
        <main className="min-h-screen bg-[#0a0a0a] text-white font-sans antialiased overflow-x-hidden">
            ...
            <section className="relative w-full overflow-hidden bg-[#0a0a0a]">
                ...
                <div className="relative z-10 pt-20 pb-12 text-center max-w-4xl mx-auto px-6">
                    ...
                    <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.6 }}
                        ...
                        Alugue máquinas<br />pesadas <span className="text-primary">em SC.</span>
                    </motion.h1>
            ...
            <section className="py-16 lg:py-20 bg-gray-50">
                <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <motion.h2 initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.3 }} transition={{ duration: 0.6 }}
                        className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-12">Quem constrói com a Jacó<br />recomenda</motion.h2>
