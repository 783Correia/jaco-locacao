...
const MODELS: Model[] = [
    ...
    { name: "Telescópica 28m", fullName: "Plataforma Telescópica Diesel 28m", description: "Maior alcance da frota com 28 metros. Para trabalhos em grande altura: torres, fachadas e estruturas elevadas.", category: "articulada", image: "/frota/plataforma-telescopica-diesel-28m.png", video: "/frota/plataforma-telescopica-video.mp4", cardSpecs: { "Altura Trab.": "28m", "Alc. Horiz.": "22,9m", "Capacidade": "227kg", "Peso": "16732kg", "Dimensões": "2,49x12,19x3,05m" } },
];
