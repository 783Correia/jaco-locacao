            ...
            <footer className="py-6 bg-[#0a0a0a]">
                <div className="max-w-6xl mx-auto px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-5">
                        <a href="https://www.instagram.com/jacolocacao?igsh=MWZ5ZGxkNHRnc2w4dg%3D%3D" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
